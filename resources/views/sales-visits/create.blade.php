                    ...
                    <div class="app-panel p-5 sm:p-6">
                        ...
                        <div class="app-soft-panel mt-6 p-4" x-show="outletCondition === 'buka'" x-transition>
                            ...
                            <div class="mt-4 grid gap-4">
                                <div>
                                    <x-input-label for="order_amount" value="Nominal order" />
                                    <x-text-input id="order_amount" name="order_amount" type="number" min="0" step="0.01" class="mt-2 block w-full" :value="old('order_amount')" placeholder="0" />
                                    <x-input-error class="mt-2" :messages="$errors->get('order_amount')" />
                                </div>
                                <div>
                                    <x-input-label for="receivable_amount" value="Total tagihan" />
                                    <x-text-input id="receivable_amount" name="receivable_amount" type="number" min="0" step="0.01" class="mt-2 block w-full" :value="old('receivable_amount')" placeholder="0" />
                    ...
                    <div class="app-panel p-5 sm:p-6">
                        ...
                        <div class="mt-4 grid gap-4">
                            ...
                            <div class="app-soft-panel p-4">
                                ...
                                <div x-show="photoName" class="mt-4 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-600">
