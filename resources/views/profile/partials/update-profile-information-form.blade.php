<section>
    <header>
        ...
        <p class="mt-1 text-sm leading-6 text-slate-500">
            {{ __('Perbarui nama, username, dan email opsional untuk akun kerja kamu.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="email" class="mt-2 block w-full" :value="old('email', $user->email)" autocomplete="email" />
